      ...
      module SchemaStatements
        ...
        def columns(table_name)
          ...
          column_definitions(table_name).map do |column_name, type, default, notnull, oid, fmod, collation, comment|
            ...
            new_column(column_name, default_value, type_metadata, !notnull, default_function, collation, comment)
          end
        end

        def new_column(name, default, sql_type_metadata = nil, null = true, default_function = nil, collation = nil, comment = nil) # :nodoc:
        ...
        def table_comment(table_name) # :nodoc:
          ...
          select_value(<<-PostgreSQL.strip_heredoc, 'SCHEMA')
