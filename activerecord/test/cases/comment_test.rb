...
class CommentTest < ActiveRecord::PostgreSQLTestCase
  ...
  def setup
    ...
    @connection.transaction do
      @table = @connection.create_table('commenteds', comment: 'A table with comment', force: true) do |t|
  ...
  if ActiveRecord::Base.connection.supports_comments?
    ...
    def test_schema_dump_with_comments
      ...
      assert_match %r[create_table "commenteds", force: :cascade, comment: "A table with comment"], output
